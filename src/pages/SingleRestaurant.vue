            ...
            <form @submit.prevent="saveData()">
              <div v-for="(dish, index) in restaurant.dishes" :key="index">
                <div>
                  <article class="wrapper" id="demo">
                    <input :id="'check-' + index" class="check ms-1 mt-2" type="checkbox" :value="dish"
                      v-model="order.dish">
                    <div>
              ...
              <div>
                <div class="m-4">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button id="cart" class="text-white btn rounded-3 m-4 " type="submit">Aggiungi al
                              carrello</button>
                  ...
                  <router-link class="text-decoration-none text-white btn rounded-3" :to="{ name: 'checkout' }">Vai al
